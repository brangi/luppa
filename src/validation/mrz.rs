use crate::models::{MrzData, VisualData, MrzValidationResult};
use crate::utils::PassportError;

pub struct MrzValidator;

impl MrzValidator {
    pub fn validate(_mrz_data: &MrzData, _visual_data: &VisualData) -> Result<MrzValidationResult, PassportError> {
